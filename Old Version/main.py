...
class World:
    ...
    def add_relationship(
        ...
        """
        Adds a relationship between two entities in the graph database.

        Args:
            source (str): The name of the source entity.
            rel_type (str): The type of the relationship.
            target (str): The name of the target entity.
            properties (Dict[str, Any], optional): Additional properties for the relationship. Defaults to None.

        Returns:
            Dict[str, Any]: The created relationship details.

        Raises:
            ValueError: If the source or target entity does not exist.
        """
